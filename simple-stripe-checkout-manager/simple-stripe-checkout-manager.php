<?php
/*
 * Plugin Name: Simple Stripe Checkout Manager Lite
 * Author: Kyle M. Brown <kyle@kylembrown.com>
 * Plugin URI: 
 * Description: This plug-in will show stripe checkout transaction details such as customer name, purchasae amount, date, and more within your WordPress admin area.
 * Version: 1.1
 * Author URI: 
 * License: GPL2
 */
...
function register_plugin_styles() {
	wp_register_style( 'strip-transaction-pro', plugins_url( 'stripe-checkout-pro-manager/css/strip-transaction-style.css' ) );
